...
MODULES = [
    ...
    "ai_analysis.rate_limiter",
    "ai_analysis.cache",
    "ai_analysis.filing_sections",
    "ai_analysis.filing_structure_analyzer",
    "ai_analysis.risk_factor_analyzer",
    "ai_analysis.insider_transaction_analyzer",
    "ai_analysis.transcript_sentiment_analyzer",
    "portfolio.construction",
    "portfolio.optimization",
    "portfolio.risk_models",
    "risk.risk_management",
    "risk.stress_testing",
    "risk.circuit_breaker",
    "risk.decomposition",
    "risk.correlation_monitor",
    "risk.gate",
